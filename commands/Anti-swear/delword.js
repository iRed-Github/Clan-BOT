...
category: 'anti-swear',run: async (client, message, args) => {
    ...
    if (!word) {
      ...
      .setFooter(message.author.tag + " | made by iRed & Sestro with ♥", message.author.displayAvatarURL())
    ...
    if (pog) {
            ...
            let No = new Discord.MessageEmbed()
                ...
                No.setColor("#FF0000")
                No.setFooter(message.guild.name + " | made by iRed & Sestro with ♥", message.guild.iconURL());
            ...
            let embed = new Discord.MessageEmbed()
                ...
                embed.setFooter(message.guild.name + " | made by iRed & Sestro with ♥", message.guild.iconURL());
